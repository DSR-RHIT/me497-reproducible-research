...
\includegraphics[width = 1\textwidth]{images/rr-cycle.png}
...
\begin{columns}[c]
\column{0.2\textwidth}
\includegraphics[width = 0.77\textwidth]{images/stodden-cover.jpg}
...
\begin{columns}[c]
\column{0.2\textwidth}
\includegraphics[width = 0.77\textwidth]{images/gandrud-cover.jpg}
...
\vspace{-1\baselineskip}
\includegraphics[width = 1\textwidth]{images/reproducibility-in-the-news.png}
\end{columns}
\end{frame}
}%%
...
\column{0.4\textwidth}
\includegraphics[width = 1\textwidth]{images/rogoff-reinhart.png}\\
...
\column{0.4\textwidth}
\includegraphics[width = 1\textwidth]{images/anil-potti.jpg}\\
...
\includegraphics[width = 1\textwidth]{images/hockey-stick-graph.png}\\
...
\includegraphics[width = 1\textwidth, trim = 0 0 0 20mm, clip = TRUE]{images/geek-tasks.png}
...
\column{0.45\textwidth}
\vspace{-1\baselineskip}
\includegraphics[width = 1\textwidth]{images/calibr-report-first-page.png}
