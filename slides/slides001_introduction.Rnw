...
\begin{itemize}
	\item clinical trials (real patients) terminated
	\item 11 cases of malpractice settled
	\item 18 journal articles retracted
	\item NIH requires Duke obtain preapproval for funding changes
\end{itemize}
