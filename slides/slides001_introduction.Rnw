...
\begin{frame}[c]{Reproduction revealed that their primary findings were false}
...
\begin{frame}[c]{Reproduction revealed that he falsified data}
...
\begin{frame}[c]{Reproduction, however, is also used to {\em discredit scientists}}
