...
{%% title slide -------------------------------------------
\renewcommand\foottext{Roger Peng (2011) Reproducible research in computational science. {\em Science} {\bf 334}(6060), 1226--1227.}
\begin{frame}[c]{}
...
Ivan Oransky, \href{http://retractionwatch.com/2015/11/07/its-official-anil-potti-faked-data-say-feds/}{It's official: Anil Potti faked cancer research data, say Feds}, {\em Retraction Watch}, 2015-11-07.}
...
\begin{frame}[c]{Reproduction is also used to {\em discredit scientists}}
...
\begin{frame}[c]{Our focus is on explicitly linking the report, paper, or talk to the data and scripts that generate the findings}
...
\begin{frame}[c]{How the course is organized}

\begin{itemize}
	\item Course materials are reproducible.\\
	{\small\bf\url{https://github.com/DSR-RHIT/me497-reproducible-research}}
	\item \href{https://github.com/DSR-RHIT/me497-reproducible-research/blob/master/cm/cm001_syllabus.md}{Syllabus}
	\item \href{https://github.com/DSR-RHIT/me497-reproducible-research}{Week 0 assignments}
\end{itemize}
