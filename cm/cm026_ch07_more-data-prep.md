...
```
    ...
    ## 7     AR           Argentina  2005        36.40
    ## 8     AM             Armenia  2005        22.69
    ## 9     AU           Australia  2005        44.85
    ## 10    AT             Austria  2005       135.72
...
```
    ...
    ## 7     AF Afghanistan  2011         6.33
    ## 8     AL     Albania  2005       111.60
    ## 9     AL     Albania  2006        85.09
    ## 10    AL     Albania  2007        87.17
...
```
    ...
    ## 7   2011    AF Afghanistan         6.33
    ## 8   2005    AL     Albania       111.60
    ## 9   2006    AL     Albania        85.09
    ## 10  2007    AL     Albania        87.17
...
The output tells us that Korea is listed in the data set as Korea, Rep., that is, what we usually refer to as South Korea.
...
```
    ...
    ## 7   2011    AF Afghanistan         6.33         0.801
    ## 8   2005    AL     Albania       111.60         2.048
    ## 9   2006    AL     Albania        85.09         1.930
    ## 10  2007    AL     Albania        87.17         1.940
