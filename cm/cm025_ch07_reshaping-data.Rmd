...
We have `r number_NA` NAs in the fertilizer consumption column, or `r round(100*number_NA/number_rows, 0)`%  of the `r number_rows` observations. After we delete the NA entries, we should end up with `r number_rows - number_NA` rows. 
...
```{r include=FALSE}
library(readr)
write_csv(CompleteLongFert, "results/CompleteLongFert.csv")
```
