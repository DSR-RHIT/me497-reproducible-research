...
# me497-reproducible-research
  ...
  - [Organized by chronology](../README.md)
  - Organized by topic (this page)
...
## course management
  ...
  - [Course introduction](../slides/slides001_introduction.pdf)
    \[slides\]
  - [Three principles of
    reproducibility](../slides/slides003_start-report.pdf) \[slides\]
...
## software
  ...
  - [R and RStudio:
    Install](https://github.com/DSR-RHIT/install-R-and-RStudio)
  - [RStudio: Set up an R
    Project](https://github.com/DSR-RHIT/install-R-and-RStudio)
  - [Git and GitHub:
Setup](cm003_git-setup.md)
