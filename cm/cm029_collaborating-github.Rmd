...
```{r echo=FALSE}
knitr::include_graphics("../resources/images/github-accept-invitation.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("../resources/images/github-clone-button.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("../resources/images/clone-new-local-project.png")
```
