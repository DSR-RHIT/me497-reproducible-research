...
As time goes on and you want to experiment with styles, you can make a copy of your current reference file and rename it, e.g., `word-styles-02.docx`, leaving the prior version alone (you know it works). If the experiment fails, you can always revert to the earlier reference file. 
