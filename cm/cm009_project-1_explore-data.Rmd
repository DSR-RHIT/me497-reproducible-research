...
`r code_icon` (*add code* reminder: insert a code chunk, then transcribe the R code) 
...
`r text_icon` (*add text* reminder: type the prose verbatim into the Rmd file) 
...
```{r 01-03, fig.cap = 'Figure 1. Load cell calibration test setup'}
