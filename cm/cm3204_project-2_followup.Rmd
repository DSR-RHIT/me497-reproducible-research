...
The scripts you write to explain your reproduction of someone else's work can be considered what  Zumel and Mount [-@zumelmount2014] call *milestone documentation.*   As they explain, milestone documentation is a readable summary of 
...
- can be concise
- includes code 
- allows others to assess your work, i.e., check that it works, that you state your assumptions, explain choices you've made, etc. 
...
1. You can use (or ask help using) the Web of Science database for tracking down a chain of references. Ryan can help you with this too. 
...
The balance between Rmd code chunks and R scripts is up to you. Find the balance that works for you while still meeting the overall goal of milestone documentation and collaborator readability. 
