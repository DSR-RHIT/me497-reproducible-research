...
- [Calendar](cm0002_calendar.md) for an outline of our agendas and due dates  
...
- [Course introduction](../slides/slides001_introduction.pdf) [slides 001] 
...
- [Project 3 getting started](cm7301_project-3_start.md) ME 597 students only



## file management 

- [Workflow, managing files, & naming things](../slides/slides011_workflow-files-names.pdf) [slides 011] 
...
- [Framework for reproducible reports](slides/slides002_framework.pdf) [slides 002] 
...
1. [What does research reproducibility mean?](../resources/readings/2016-Goodman-et-al-what-does-RR-mean.pdf)
1. [Shining light onto black boxes](../resources/readings/2012-Morin-Shining-light-into-black-boxes.pdf) 
1. [Ten simple rules for reproducible computational  research](../resources/readings/2013-Sandve-et-al-Ten-simple-rules.pdf)
1. [Reproducible research can still be wrong](../resources/readings/2015-Leek-Peng-RR-can-still-be-wrong.pdf) 
1. [Reproducible research: a dissenting opinion](../resources/readings/2012-Drummond-RR-dissenting-opinion.pdf)
